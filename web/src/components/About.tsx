  ...
  return (
    <section id="about" className="py-16 bg-dark-200">
      <div className="container">
        <h2 className="text-4xl font-bold mb-8 text-primary-500">About Me</h2>

        <p className="text-lg text-gray-200 indent-8 mb-6">
        ...
        <p className="text-lg text-gray-200 indent-8">
